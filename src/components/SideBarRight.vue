<template>
    <v-navigation-drawer app color="white" right width="300">
        ...
        <v-toolbar color="rgba(0,0,0,0)" flat class="mt-n6">
            <span>Tax(10%)</span> <v-spacer></v-spacer>
            <span>$1.831</span>
        </v-toolbar>
        <v-divider class="mx-4"></v-divider>
        <v-toolbar color="rgba(0,0,0,0)" flat>
            <strong>Total</strong> <v-spacer></v-spacer>
            <strong>$20.141</strong>
        </v-toolbar>
        ...
        <div class="mx-3 mt-2">
            <v-btn color="#704232" block dark class="withoutupercase">
                Print Bills
            </v-btn>
        </div>
    </v-navigation-drawer>
